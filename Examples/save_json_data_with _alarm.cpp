...
void callback1(int id, bool isOn, JsonObject& zoneData) {
  Serial.println("=== CALLBACK 1 TRIGGERED ===");
  Serial.println("ID: " + String(id) + ", Action: " + (isOn ? "ON" : "OFF"));
  Serial.print("Zone Data: ");
  serializeJson(zoneData, Serial);
  Serial.println();
}

void callback2(int id, bool isOn, JsonObject& zoneData) {
...
void callback3(int id, bool isOn, JsonObject& zoneData) {
...
void callback4(int id, bool isOn, JsonObject& zoneData) {
